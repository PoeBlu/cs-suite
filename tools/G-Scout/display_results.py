...
def display_results(db, projectId):
        ...
        def generate_entities_page(category, header, fields,dropdowns):
                ...
                with open(f"Report Output/{projectId}/{category}s.html", "w+") as file:
